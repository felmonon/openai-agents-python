...
-   **[tools](https://github.com/openai/openai-agents-python/tree/main/examples/tools):**
    ...
    -   Experimental Codex planner / builder / QA tool, including resumable contract artifacts, a local-tools backend, and optional Playwright-backed browser QA (`examples/tools/codex_builder_qa.py`)
